                            ...
                            <Card.Body className="p-5 text-center">
                                ...
                                <div className="mb-md-5 mt-md-4 pb-5">
                                    ...
                                    <Form>
                                        ...
                                        <Button variant="outline-light" size="lg" className="px-5 mt-2" type="submit">Login</Button>
                                    </Form>
                                    <p className="small mb-5 pb-lg-2">
                                        {/* Correctly use the Link component */}
                                        <p className="mb-0 mt-4">Don't have an account? <Link to="/register" className="text-white">Sign up</Link></p>
                                    </p>
                                </div>
